...
export class AccessCourseMaterialsComponent {
  courseMaterials = [
    { courseName: 'Mathematics 101', instructorName: 'Dr. John Doe', fileUrl: '/test.txt' },
    { courseName: 'Physics Basics', instructorName: 'Prof. Jane Smith', fileUrl: '/test.pdf' },
    { courseName: 'Chemistry Advanced', instructorName: 'Dr. Emily Johnson', fileUrl: '/test.pdf' },
  ];
